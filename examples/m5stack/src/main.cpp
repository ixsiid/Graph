...
#define I2C_EXAMPLE_MASTER_TX_BUFFUR_DISABLE 0		 /* I2C master do not need buffer */
#define I2C_EXAMPLE_MASTER_RX_BUFFUR_DISABLE 0		 /* I2C master do not need buffer */
#define I2C_EXAMPLE_MASTER_FREQ_HZ 100000UL		 /* I2C master clock frequency */
...
esp_err_t initI2C(i2c_port_t i2c_port) {
	...
	ESP_ERROR_CHECK(i2c_driver_install(i2c_port, conf.mode,
								I2C_EXAMPLE_MASTER_RX_BUFFUR_DISABLE,
								I2C_EXAMPLE_MASTER_TX_BUFFUR_DISABLE, 0));
